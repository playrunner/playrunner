...
In the Workflow Editor, you can specify a **Concurrency Limit** (e.g., `1`, `3`, `10`). This instructs the Orchestrator on how many *internal* parallel nodes to process simultaneously within a single workflow diagram.
