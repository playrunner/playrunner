...
Playrunner is early. The current roadmap is focused on making Playwright test
orchestration more reliable, visible, and easier to extend.
...
This page is a starting point for contributors. The detailed roadmap should stay
close to the GitHub issues and discussions as the project changes.
