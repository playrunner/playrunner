...
title: Set up Playrunner locally
description: Set up the full Playrunner stack locally with Docker and Node 20 in about fifteen minutes, then sign in and open the workflow canvas.
keywords: ['playrunner setup', 'self-host playwright orchestration']
---
