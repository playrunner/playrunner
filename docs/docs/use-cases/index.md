...
description: 'Workflows built on the Playrunner canvas: Slack alerts, Jira bugs, AI failure triage, scheduled runs, webhook triggers, and automatic suite sharding.'
