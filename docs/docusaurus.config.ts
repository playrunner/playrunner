...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        {
          // Site-wide footer links are how the /compare/* pages earn internal
          // links: they live in src/pages, so they never appear in the
          // autogenerated docs sidebar.
          title: 'Compare',
          items: [
            { label: 'All comparisons', to: '/compare' },
            {
              label: 'vs GitHub Actions',
              to: '/compare/playrunner-vs-github-actions',
            },
            {
              label: 'vs Azure Playwright Workspaces',
              to: '/compare/playrunner-vs-azure-playwright-workspaces',
            },
            { label: 'vs Currents', to: '/compare/playrunner-vs-currents' },
            {
