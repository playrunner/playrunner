              ...
              <>
                <div className="bg-[var(--background)] border border-subtle rounded-lg p-4 space-y-4">
                  ...
                  <p className="text-xs text-muted">
                    Connect your account to allow this node to perform actions
                    on your behalf.
                  </p>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] text-muted">
                    Choose the runtime image used for this repository run.
                  </p>
                </div>
            ...
            {config.action === 'run' && (
              <div className="flex flex-col gap-1.5 shrink-0">
                ...
                <p className="text-[10px] text-muted mt-1">
                  ...
                  You can drag environment variables directly from the panel
                  into the editor.
                </p>
                <p className="text-[10px] text-muted">
                  Inline scripts always run in the TypeScript Playwright runner.
                </p>
              </div>
            )}
                ...
                <div className="bg-[var(--background)] border border-subtle rounded-lg p-3 space-y-3">
                  <div className="space-y-2">
                    ...
                    <ul className="text-[11px] text-muted space-y-1.5 list-disc pl-4">
                      <li>
                        Currently only supports <strong>TypeScript</strong>.
                      </li>
                      <li>
                        Zip the files from <strong>within</strong> the directory
                        containing your config (do not zip the parent folder
                        itself).
                      </li>
                      <li>
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onChange={(e) =>
                  onChange(nodeId, {
                    ...config,
                    playwrightVersion: e.target.value,
                  })
                }
              ...
              <p className="text-[10px] text-muted">
                Select the version of Playwright to use for this runner
                container.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-[10px] text-muted leading-relaxed">
                These variables will be injected directly into the container
                environment when running your tests.
              </p>
            </div>
          </div>
        )}
