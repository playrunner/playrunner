    ...
    <main className="flex-1 overflow-y-auto p-8 max-w-4xl mx-auto w-full space-y-8">
        <div className="bg-surface border border-subtle rounded-2xl overflow-hidden shadow-sm">
          <div className="p-6 border-b border-subtle">
            ...
            <p className="text-sm text-muted">Manage your personal information and preferences.</p>
          </div>
          
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <label className="text-sm font-medium text-muted md:pt-2">Name</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <label className="text-sm font-medium text-muted md:pt-2">Email address</label>
              <div className="md:col-span-3">
                <Input defaultValue="ajbarry99@gmail.com" disabled className="max-w-md" />
