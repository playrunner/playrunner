    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <Select
          ...
          onChange={(e) =>
            onChange(nodeId, { ...config, action: e.target.value })
          }
        >
      ...
      {config.action === 'update' ? (
        <div className="space-y-1.5">
          ...
          <Input
            ...
            onChange={(e) =>
              onChange(nodeId, { ...config, issueKey: e.target.value })
            }
            placeholder="PROJ-123 or {{trigger.issueKey}}"
          />
          <p className="text-[10px] text-muted">
            The Jira issue key to update.
          </p>
        </div>
      ) : (
        <>
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onChange={(e) =>
                onChange(nodeId, { ...config, projectId: e.target.value })
              }
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onChange={(e) =>
                onChange(nodeId, { ...config, issueType: e.target.value })
              }
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          onChange={(e) =>
            onChange(nodeId, { ...config, summary: e.target.value })
          }
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          onChange={(e) =>
            onChange(nodeId, { ...config, description: e.target.value })
          }
